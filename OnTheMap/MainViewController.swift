...
class MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        logOutBarButtonItem.setTitleTextAttributes([NSFontAttributeName: font, NSForegroundColorAttributeName: OTMClient.Color.blue], for:UIControlState.normal)
        ...
        addBarButtonItem.tintColor = OTMClient.Color.blue
        ...
        refreshBarButtonItem.tintColor = OTMClient.Color.blue
        ...
        DataSource.getStudents { (students: [Student]) in
            ...
            for student in students {
                ...
                if let mediaURL = student.mediaURL {
                    ...
                    annotation.subtitle = "https://ybarra.io"
                }
